...
@Component({
  ...
  templateUrl: './reports-orders-by-employee.component.html',
  styleUrls: ['./reports-orders-by-employee.component.css']
})
export class ReportsOrdersByEmployeeComponent implements OnInit {
  ...
  private getOrders() {
    ...
    console.log(id);
    this.orderService.getOrderListByEmployeeId(id).subscribe(data => {
      this.orders = data;
    });
  }
